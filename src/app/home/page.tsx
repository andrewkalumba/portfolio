        ...
        <div className="flex justify-center items-center bg-[#466995]">
            <div className="w-[30%]">
               <div className="flex justify-center text-base uppercase p-1.5 font-bold text-amber-50"> <ReusableH2 title="frontend developer" /> </div>
                <ReusableInfo text="I specialize in building exceptional digital experience. With a focus on performance and accessibility, I transform designs into high quality products that delight users and make a postive impact." />
            </div>
